...
const RegisterPage: React.FC = () => {
  ...
  // FIX: Se pasa credentialResponse.credential (el JWT string) directamente
  // a loginWithGoogle. Antes se pasaba el objeto decodificado, lo que causaba
  // que supabase.auth.signInWithIdToken() recibiera un objeto en lugar de un token.
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <a
                ...
                className="inline-block mt-3 px-3 py-1 bg-red-600 text-white font-semibold rounded hover:bg-red-700"
              >
