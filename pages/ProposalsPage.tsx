      ...
      <Modal isOpen={isModalOpen} onClose={() => { if(!isSubmitting) { setIsModalOpen(false); setForm(initialFormState); } }} title="Crear Nueva Propuesta">
        <form onSubmit={handleSubmit} className="space-y-5 p-1">
          <div>
            ...
            <select name="client_id" value={form.client_id} onChange={handleChange} required className="w-full bg-gray-900 border border-gray-800 rounded-xl px-4 py-3 text-white focus:border-primary-500 outline-none appearance-none cursor-pointer">
